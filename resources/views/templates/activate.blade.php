                                 ...
                                 <tr>
                                    <td>
                                       <table align="left" border="0" cellspacing="0" style="width:50%">
                                          <tbody>
                                             <tr>
                                                <td align="left" class="preheaderContent" mc:edit="preheader_content00" style="text-align:left!important;" valign="top">Welcome to DateNight!</td>
                                             </tr>
                                          </tbody>
                                       </table>
                                       <table align="left" border="0" cellspacing="0" style="width:50%">
                              ...
                              <tbody>
                                 <tr>
                                    <td id="header" style="background-color:#7030D9; color:#FFFFFF!important; padding-top : 20px" valign="top">
                                       <h1 style="font-size: 30px; color: #fff;">DateNight </h1>
                                 ...
                                 <tr>
                                    <td align="middle" style="background:#FFFFFF;">
                                       <p style="display:block; font-size: 20px;">Your Account has been approved.</p>
                                    </td>
                                 </tr>
                                       ...
                                       <table border="0" cellpadding="10" cellspacing="0" style="width:100%">
                                          <tbody>
                                             <tr>
                                                <td valign="top">
                                                   &nbsp;
                                                   <div mc:edit="std_footer"><em>Copyright © 2020 DateNight app, All rights reserved.</em></div>
                                                </td>
                                             </tr>
                                          </tbody>
                                       </table>
