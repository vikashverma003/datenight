                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td >
                              ...
                              <a href="{{route('viewUser',$com->id)}}" class="badge badge-success">Active</a>
                              @else
                              <a href="{{route('viewUser',$com->id)}}" class="badge badge-danger">Inactive</a>
                              @endif
                           </td>
                           <td >
                              @if($com->approved_status=='0')
                              <a href="{{route('viewApproved',$com->id)}}" class="badge badge-success">Approved</a>
                              @else
                              <a href="{{route('viewApproved',$com->id)}}" class="badge badge-danger">Unapproved</a>
                              @endif
                           </td>
                           <td>
                            ...
                            <a class="action-button" href="{{route('delete',$com->id)}}" data-toggle="tooltip" title="Edit">
